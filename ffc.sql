...
INSERT INTO `foodlist` (`fid`, `fname`, `fprice`, `fdescription`, `fimage`, `manager`, `foodstatus`,`frestaurents`) VALUES
(20, 'Hummus', '14', 'with sourdough, crispy chickpeas & zaatar', '1.avif', 'ravis', 'available','ravis hotel'),
(21, 'Chicken Parma', '27', 'schnitzel topped with Napoli sauce, ham and cheese with chips & dressed leaves', '2.avif', 'ravis', 'available','ravis hotel'),
(22, 'Snapper Fritters (3)', '10', 'with parmesan aioli', '3.avif', 'ravis', 'available','ravis hotel'),
(23, 'Taphouse Fried Chicken', '16', 'with southern mayonnaise','4.avif', 'ravis', 'available','ravis hotel'),
(25, 'Salt & Pepper Popcorn Tofu', '26', 'with lemongrass dressing','5.avif', 'qwe', 'available','ravis hotel'),
(28, 'Stomping Ground Big Sky Hazy Pale', '7.5', 'A Gentle haze, big tropical fruit and citrus flavours, balanced bitterness and a refreshing finish. - 4.3% (VIC)','6.avif', 'qwe', 'available','ravis hotel'),
(29, 'Stomping Ground Bunker Porter', '7.8', 'Rich in chocolate and roast characters, our porter is also dark, mysterious and full of secrets. - 5.8% (VIC)','7.avif', 'qwe', 'available','ravis hotel'),
(30, 'Swell Season Rose', '13(Glass)', ' ','8.avif', 'qwe', 'available','ravis hotel'),
(31, 'Dune Blewitt Springs Shiraz', '14(Glass)', ' ','9.avif', 'qwe', 'available','ravis hotel'),
(32, 'Coke', '4.5', ' ','10.avif', 'qwe', 'available','ravis hotel');
...
INSERT INTO `foodorders` (`orderid`, `fid`, `fname`, `fprice`, `qty`, `ordereduser`, `totalprice`, `ordered_date`, `payment_type`, `res_status`) VALUES
(42, 20, 'chiken biriyani', 120,  2, 'bhagyanath123', 240, '2021-01-09', 'online', 'delivered'),
(43, 23, 'shavarma', 120,  1, 'ravis', 120, '2021-07-15', 'cod', 'shipped'),
(44, 22, 'Chicken curry', 150,  1, 'joel', 150, '2021-07-15', 'online', 'shipped'),
(45, 25, 'falooda', 120,  1, 'mammootty', 120, '2021-07-15', 'cod', 'delivered'),
(46, 25, 'falooda', 120,  1, 'bhagyanath123', 120, '2021-07-15', 'online', 'delivered'),
(47, 23, 'shavarma', 120,  1, 'midhun123', 120, '2021-07-15', 'cod', 'delivered');
