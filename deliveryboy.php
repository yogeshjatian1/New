 ...
 ?>
  ...
  <div class="container-fluid">
       ...
       <div class="col-md-8 pt-1 pb-3">
           <legend class="text-center" style="border:1px solid black; width: 100%; margin: 0 auto;">Delivery Boys (Online Here)
           <?php
           //getting delivery boys that are online
            $sql = "SELECT * FROM deliveryboy WHERE dstatus='Ready';";
          ...
          ?>
            <table class="table table-responsive-md mytbl text-center">
                ...
                <td><a href="choose.php?name=<?php echo $row['uname']; ?>" class="btn btn-primary btn-sm">Choose</a>  
                <?php  
                }
                ?>  
                </tbody>
